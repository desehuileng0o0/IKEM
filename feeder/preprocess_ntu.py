...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/lsdf/data/activity/NTU_RGBD/zipped/zipped_skeleton_csv/NTU-RGB-D-120')
    parser.add_argument('--out_folder', default='/lsdf/data/activity/NTU_RGBD/zipped/zipped_skeleton_csv/NTU120_frame50')
