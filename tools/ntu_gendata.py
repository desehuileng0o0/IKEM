...
def gendata(data_path,
    ...
    with open('{}/{}_label.pkl'.format(out_path, part), 'wb') as f:
        pickle.dump((sample_name, list(sample_label), list(sample_frame)), f)
    end_toolbar()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='/lsdf/data/activity/NTU_RGBD/zipped/zipped_skeleton_csv/TEST')
